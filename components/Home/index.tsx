        ...
        <div className="">
            <div className="bg-green-20 lg:p-32 md:p-20 lg:flex lg:justify-center w-full">
                <div className="lg:flex">
                    <div className={`lg:h-96 lg:w-1/2  p-5 ${page == 'p' ? 'block' : 'hidden'} `}>
                        <div className="px-5">
                            <p className="text-indigo-400 lg:text-4xl text-xl mt-20 font-bold">
                        ...
                        <div className="mt-10 flex justify-between">
                            <div>
                                <button
                                    onClick={download}
                                    className="text-white bg-green-550 rounded-full p-2 w-40 lg:block md:block hidden"
                                >
                                    دانلود شاپیفای
                                </button>
                            </div>
                    ...
                    <div
                        className={`lg:h-96 lg:w-1/2 lg:mt-10 p-5 ${
                            page == 'p1' ? 'block' : 'hidden'
                        }`}
                    >
                        <div className="px-7 mt-20">
                            <p className="text-indigo-400 lg:text-4xl text-xl font-bold">
                                تغییر کن تا آیندرو حس کنی{' '}
                            </p>
            ...
            <div className="h-auto bg-green-10">
                <div className="-mt-9 ">
                    ...
                    <div className="overflow-x-auto px-5 lg:hidden md:hidden block mt-5">
