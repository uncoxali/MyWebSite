    ...
    return (
        <>
            <div className="bg-green-10">
                <div className="bg-green-10">
                    <Navbar />
                    <div className="h-screen w-full lg:px-32 md:px-28 px-5">
                        <div className="">
                            ...
                            <div className="lg:flex-none md:flex-none flex justify-center mt-5">
                                <div className="w-75 h-90 border-2 border-primary rounded-2xl ">
                                    <div className="flex justify-center mt-3">
                                        <p className={cn(Style.text, 'font-bold')}>سرویس شما </p>
                                    </div>
                                    ...
                                    <div className="flex justify-center relative">
                                        <div className="absolute mt-14">
                                            ...
                                            <p className="text-white text-center mt-10 font-bold">
                                                اعضای عمومی میتواند 5 لینک بسازد و با تعداد نا محدود
                                                لینک های ساخته شده توسط دیگران را مشاهده کنند
                                            </p>
                                        </div>
                                    </div>
                ...
                <div className="bg-green-10">
                    <div className="lg:h-0 md:h-0 h-screen "></div>
                    <div className="lg:h-0 md:h-0 h-screen "></div>
