...
export default function index() {
    return (
        <div className="bg-green-10">
            <Navbar />
            <div className="h-scree w-full lg:px-40 md:px-36 px-10">
                <div className="">
                ...
                <div className="mt-10">
                    ...
                    <input
                        ...
                        className="placeholder-black mt-2 p-5 lg:w-2/3 md:w-2/3 w-full focus:outline-none focus:ring focus:border-blue-200 ..."
                    />
                </div>
                <div className="mt-20">
                    <p>توضیحات</p>
                    <textarea
                        placeholder="توضیحات سفارش رو اینجا بنویسید"
                        className="h-52 placeholder-black mt-2 p-5 lg:w-2/3 md:w-2/3 w-full focus:outline-none focus:ring focus:border-blue-200 ..."
                    />
                </div>
